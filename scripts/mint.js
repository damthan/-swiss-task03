...
async function main() {
   ...
   const contractFactory = await hre.ethers.getContractFactory("ERC721Test");
   ...
   console.log(`Transaction hash: https://explorer-evm.testnet.swisstronik.com/tx/${safeMintTx.hash}`);
}
